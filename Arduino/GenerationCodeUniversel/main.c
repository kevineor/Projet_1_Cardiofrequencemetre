...
{
    int z;
    int Pouls=0; //z sera la valeur commune pour le fichier "param.h", qui sélectionnera l'option dans le programme Arduino; et Pouls sera le nombre de BPM qu'on souhaitera simuler
