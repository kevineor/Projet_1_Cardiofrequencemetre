...
{
    FILE *f=fopen("C:\\Users\\vzonz\\Documents\\GitHub\\Projet_1_Cardiofrequencemetre\\M3.2\\ProgrammeCoeur\\param.h","w"); //Ici, on crée un pointeur de fichier qui s'appelera "f", dans lequel on l'envoit ouvrir (ou créer s'il n'existe pas) le fichier param.h
